...
import full_cost.utils.entities
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='price',
            name='price_category',
            field=models.CharField(choices=[('T1', 'CNRS Interne'), ('T2', 'CNRS Externe'), ('T3', 'Private')], default=full_cost.utils.entities.PriceCategory['T1'], max_length=200),
        ),
        migrations.AlterField(
            model_name='price',
            name='price_entity',
